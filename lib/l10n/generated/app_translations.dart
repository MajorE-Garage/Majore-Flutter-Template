...
import 'app_translations_sw.dart';

// ignore_for_file: type=lint

/// Callers can lookup localized strings with an instance of AppTranslations
/// returned by `AppTranslations.of(context)`.
///
/// Applications need to include `AppTranslations.delegate()` in their app's
...
class _AppTranslationsDelegate extends LocalizationsDelegate<AppTranslations> {
  ...
  Future<AppTranslations> load(Locale locale) {
    return SynchronousFuture<AppTranslations>(lookupAppTranslations(locale));
  }
...
AppTranslations lookupAppTranslations(Locale locale) {
  // Lookup logic when only language code is specified.
  switch (locale.languageCode) {
    case 'ar':
      return AppTranslationsAr();
    case 'en':
      return AppTranslationsEn();
    case 'fr':
      return AppTranslationsFr();
    case 'sw':
      return AppTranslationsSw();
  }

  throw FlutterError(
    'AppTranslations.delegate failed to load unsupported locale "$locale". This is likely '
